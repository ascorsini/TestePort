...
<body>
    <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-dark bg-dark">
        <div class="container">
            @Html.ActionLink("Teste Portifolio", "Index", "Home", New With {.area = ""}, New With {.class = "navbar-brand"})
            ...
            <div class="collapse navbar-collapse d-sm-inline-flex justify-content-between">
                <ul class="navbar-nav flex-grow-1">
                    <li>@Html.ActionLink("Associado", "Index", "Associado", New With {.area = ""}, New With {.class = "nav-link"})</li>
                    <li>@Html.ActionLink("Empresa", "Index", "Empresa", New With {.area = ""}, New With {.class = "nav-link"})</li>
                </ul>
            </div>
        </div>
    </nav>
